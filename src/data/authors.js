export const AUTHORS = [
  {
    ...
    metaDescription: 'Handcrafted joinery masterclasses, bespoke kitchen architecture, and interior styling by London designer Sarah Jenkins on Lumaa Home.',
    ...
    fullBio: [
      'With a background rooted in interior architecture and bespoke textile design, Sarah Jenkins is the driving force behind LUMAA HOME’s focused joinery masterclasses and bedroom design guides.',
  ...
  },
  {
    ...
    metaDescription: 'British period architectural restorations, listed townhouse tours, and heritage design guides by senior editor Eleanor Vance on Lumaa Home.',
    ...
    fullBio: [
      'Eleanor Vance joined LUMAA HOME™ after a decade working alongside leading British heritage preservation trusts in South Kensington and Edinburgh. Her writing documents the architectural skeleton of historic homes, uncovering original cornicing techniques, bespoke joinery, and structural authenticity.',
  ...
  },
  {
    ...
    metaDescription: 'Curated interior styling rules, antique fireplace masterclasses, and luxury British furniture edits by design director Marcus Cole on Lumaa Home.',
