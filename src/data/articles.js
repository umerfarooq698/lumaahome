...
export const ARTICLES = [
  ...
  },
  {
    ...
    "heroImage": "https://images.unsplash.com/photo-1648397831904-24e068d84b05?auto=format&fit=crop&w=1600&q=85",
    "image": "https://images.unsplash.com/photo-1648397831904-24e068d84b05?auto=format&fit=crop&w=1600&q=85",
    "heroImageAlt": "Historic panoramic view of Edinburgh Castle perched atop Castle Rock in Scotland",
    "imageAlt": "Historic panoramic view of Edinburgh Castle perched atop Castle Rock in Scotland",
    "photographer": "Lumaa Home Editorial Curation",
    "photographerUrl": "https://unsplash.com",
    "content": [
      {
        ...
        "body": "Commanding the Scottish capital from a height of 130 metres above sea level, Edinburgh Castle sits atop a formidable 350-million-year-old volcanic basalt plug known as Castle Rock. Formed during the Carboniferous period and later sculpted by colossal retreating glaciers during the Ice Age, this sheer dolerite crag provided an impregnable natural bastion that dictated Scottish defensive strategy and royal architecture for over a thousand years.\n\nMedieval master masons did not attempt to blast or level the rugged bedrock. Instead, they anchored massive multi-layered curtain walls directly into the living stone, stepping the foundation courses so the masonry worked in harmony with the natural contours. For custodians restoring period stone properties across Great Britain, this ancient site demonstrates the vital architectural principle of respecting native geology and selecting local quarry stones that naturally complement the regional climate."
      },
      {
        "level": "h3",
        "heading": "Norman Ashlar Stonework in St Margarets Chapel",
        "body": "Constructed around 1130 by King David I as a private royal oratory for his mother Queen Margaret, St Margaret's Chapel stands as the oldest surviving architectural structure in Edinburgh. Its intimate Romanesque interior showcases dressed freestone ashlar blocks with fine-line lime joints, accompanied by a semicircular chancel arch embellished with ornate chevron, dogtooth, and lozenge carvings.\n\nThe remarkable nine-century survival of this tiny Norman sanctuary highlights the superior performance of traditional hot-mixed lime mortars over modern Portland cement. Lime mortars allow moisture to evaporate continuously through the porous joints rather than becoming trapped inside the stone, shielding delicate relief carvings from catastrophic frost spalling and subsurface salt crystallization."
      },
      {
        "level": "h3",
        "heading": "The Royal Splendour of Crown Square Palace Chambers",
        "body": "Crown Square forms the ceremonial heart of the upper fortress, enclosed by grand palace chambers where Mary Queen of Scots gave birth to King James VI in 1566. The interior architecture documents a dramatic evolution from medieval military defensibility to refined Renaissance luxury, featuring monumental sandstone chimneypieces, timber-lined wall paneling, and intricately molded plaster ceilings.\n\nPreserving these historic royal apartments requires delicate environmental control and minimal chemical intervention. Modern heritage curators avoid modern plastic varnishes and synthetic sealants, relying instead on traditional natural distemper paints, breathable limewashes, and pure beeswax feeds that nourish antique Scottish oak without sealing moisture beneath the surface."
      },
      {
        "level": "h2",
        "heading": "Medieval Joinery and Timber Conservation Inside Edinburgh Castle",
        "body": "Completed in 1511 for King James IV, the Great Hall represents one of northern Europe's crowning achievements in late medieval timber engineering. The soaring ten-metre-high hammerbeam roof spans the wide cavernous interior without a single intermediate vertical support column, using ingenious cantilevered timber brackets to redirect the colossal downward thrust of the roof directly onto thick exterior stone walls.\n\nMaster carpenters constructed the entire framework from seasoned native Scottish oak, securing complex mortise and tenon joints with hand-carved cleft oak pegs rather than rigid iron spikes. This peg-and-socket joinery imparts vital structural elasticity to the entire timber system, allowing massive roof beams to flex, expand, and contract safely through extreme seasonal temperature shifts and fierce Atlantic winds.",
        "image": "https://images.unsplash.com/photo-1636360286346-68a0a9a30144?auto=format&fit=crop&w=1600&q=85",
        "imageAlt": "Dramatic stone ramparts and fortress architecture of Edinburgh Castle in Scotland",
        "imageCaption": "The ancient stone masonry and defensive ramparts of Edinburgh Castle situated atop Castle Rock.",
        "bullets": [
          "Always specify breathable non-hydraulic or feebly hydraulic lime mortars for historic stone repointing",
          "Inspect timber roof trusses annually using ultrasonic acoustic testing to identify hidden moisture pockets",
          "Prioritize traditional timber scarf joints with matched air-dried oak over non-breathable metal plates",
          "Maintain steady relative humidity between 50 and 60 percent to preserve ancient joinery and wall plasters"
        ]
      },
      {
        "level": "h3",
        "heading": "The Engineering Mastery of the Great Hall Roof",
        "body": "Sixteen sculpted stone corbels support the soaring hammerbeam trusses, featuring carved Renaissance portrait heads, heraldic animals, and pagan green men motifs celebrating Scottish royal sovereignty. The steep forty-five-degree pitch of the roof was deliberately engineered to shed heavy northern rainfall and winter snowfall rapidly, preventing water ingress from pooling above the structural timber assemblies.\n\nWhen undertaking timber repairs on such priceless carpentry, conservation specialists practice the principle of minimal intervention. Rather than replacing full structural members, damaged beam ends are carefully spliced using traditional timber scarf joints secured with seasoned oak dowels, preserving maximum original sixteenth-century fabric while restoring full structural strength."
      },
      {
        "level": "h2",
        "heading": "Translating Fortress Conservation Lessons to British Period Homes",
        "body": "The multifaceted architectural history of Edinburgh Castle offers invaluable practical insights for homeowners restoring period residences. From medieval defensive ramparts and seventeenth-century battery walls to Georgian military barracks, every era adapted the fortress using breathable, repairable materials that respected the integrity of the underlying historic fabric.\n\nIn contrast, modern domestic restorations frequently fail when owners apply quick-fix synthetic products such as impermeable Portland cement pointing, gypsum plasters, and plastic-based emulsion paints. These modern impermeable barriers trap ambient moisture inside historic brick and stone, accelerating internal masonry decay, encouraging timber rot, and triggering persistent damp problems."
      },
      {
        "level": "h3",
        "heading": "Breathable Masonry and Historic Wall Maintenance",
        "body": "Traditional solid stone and multi-wythe brick walls function through continuous moisture absorption and natural evaporation. When driven rain strikes a heritage stone wall pointed with breathable lime, moisture penetrates only into the sacrificial mortar joint and evaporates safely into the atmosphere once weather clears, keeping the structural stone core dry and protected.\n\nBefore undertaking any repointing project on a period home, property owners should commission a professional mortar analysis to match the aggregate particle size, lime-to-sand ratio, and natural color of the original historic mortar. Applying soft, vapor-permeable lime mortars ensures that the joint always remains sacrificial, protecting valuable antique bricks and stones from irreversible face spalling."
      },
      {
        "level": "h3",
        "heading": "Authentic Materiality in Historic Interior Design",
        "body": "True period interior design achieves timeless sophistication through authentic, honest materiality: hand-riven stone floor flags, wide-plank quarter-sawn oak boards, breathable mineral paints, and hand-forged black iron hardware. These traditional materials age gracefully, accumulating a rich, tactile patina that synthetic laminates and mass-produced replicas can never reproduce.\n\nBy sourcing authentic salvaged materials, engaging skilled local craftspeople, and adhering to the thoughtful conservation principles exemplified by Edinburgh Castle, homeowners can curate living spaces of genuine historical warmth, structural longevity, and enduring architectural distinction."
      },
      {
        "level": "h2",
        "heading": "Sustainable Heritage Stewardship for Modern Living Spaces",
        "body": "Preserving architectural heritage is fundamentally an exercise in sustainable living and long-term resource stewardship. The master builders of Edinburgh Castle created enduring structures using locally quarried whinstone, native Scottish oak, and natural lime binders that age with dignity across centuries rather than degenerating into disposable landfill waste.\n\nBy prioritizing sympathetic repairs over aggressive modern replacements, contemporary homeowners honor the architectural wisdom of historic builders. Whether restoring eighteenth-century sash windows or repairing lime-plastered walls, adopting the conservation philosophy of Edinburgh Castle ensures our homes remain healthy, beautiful, and deeply rooted in British craftsmanship heritage."
      }
    ],
    "faqs": [
      {
  ...
  },
  {
    ...
    "categoryLabel": "FURNITURE ARCHITECTURE • BUYING GUIDE",
    "author": "Marcus Cole",
    "authorId": "marcus-cole",
    ...
    "faqs": [
      {
        ...
        "answer": "Maintain a 25 to 30 centimetre gap between the seat top and table underside for optimal legroom."
      },
      {
        "question": "Can you mix different dining chair styles?",
        "answer": "Yes, keep seat heights identical and unify different designs with matching timber finishes or fabric tones."
      },
      {
        "question": "Which dining chair fabric lasts longest?",
        "answer": "Contract-grade performance velvet and treated saddle leather offer the highest stain resistance and durability."
      }
    ],
    "tags": [
      "Dining Chairs",
  ...
  },
  {
    ...
    categoryLabel: 'COVER STORY • KITCHEN ARCHITECTURE',
  ...
  },
  {
    ...
    readTime: '7 min read',
    views: '14.8k',
    excerpt: 'A comprehensive British guide to stripping layered paint, applying graphite wax to cast iron grates, bedding encaustic hearth tiles, and restoring period mantels.',
  ...
  },
  {
    ...
    category: 'living-room',
    categoryName: 'Living Room',
    categoryLabel: 'FEATURED • LIVING ROOM',
    author: 'Eleanor Vance',
    authorId: 'eleanor-vance',
  ...
  // GARDEN
  {
    ...
    author: 'Marcus Cole',
    authorId: 'marcus-cole',
    role: 'Landscape and Garden Design Curator',
    date: 'September 03, 2026',
    readTime: '6 min read',
    views: '13.7k',
