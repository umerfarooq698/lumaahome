  ...
  return (
    <article className="max-w-4xl mx-auto space-y-10 animate-fadeIn pb-16">
      ...
      <header className="space-y-6 text-center max-w-3xl mx-auto">
        ...
        {/* Author Byline Bar */}
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 py-4 border-t border-b border-gray-200 text-xs text-gray-600 font-semibold uppercase tracking-wider">
          {/* Author info */}
          <button
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] text-gray-400 font-normal lowercase tracking-normal">
                {author.role}
              </span>
            </div>
          </button>
      ...
      {article.keyTakeaway && (
        <div className="bg-[#FDFBF7] p-6 border-l-4 border-[#C8102E] text-gray-900 font-serif italic text-base leading-relaxed shadow-sm">
      ...
      <div className="prose max-w-none text-gray-800 leading-relaxed space-y-6 font-sans text-sm sm:text-base [&>p]:leading-relaxed [&>p.lead]:text-lg [&>p.lead]:font-serif [&>p.lead]:leading-relaxed [&>p.lead]:text-black [&>h3]:font-serif [&>h3]:text-2xl [&>h3]:font-black [&>h3]:text-black [&>h3]:pt-4 [&>h3]:border-t [&>h3]:border-gray-200 [&>blockquote]:border-l-2 [&>blockquote]:border-black [&>blockquote]:pl-6 [&>blockquote]:py-2 [&>blockquote]:italic [&>blockquote]:font-serif [&>blockquote]:text-xl [&>blockquote]:text-black [&>blockquote]:my-6 [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:space-y-2 [&>ol]:list-decimal [&>ol]:pl-6 [&>ol]:space-y-2">
        {article.content && typeof article.content === 'string' ? (
          <div dangerouslySetInnerHTML={{ __html: article.content }} />
        ) : Array.isArray(article.content) ? (
          article.content.map((section, idx) => (
            <div key={idx} className="space-y-3">
              <h3 className="font-serif text-2xl font-bold text-black pt-4 border-t border-gray-200">
                {section.heading}
              </h3>
      ...
      <section className="bg-[#FAFAF8] p-8 border border-gray-200 space-y-4 my-10 shadow-sm">
